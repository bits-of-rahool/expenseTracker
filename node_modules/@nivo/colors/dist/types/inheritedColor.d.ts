...
export declare const isInheritedColorConfigFromTheme: <Datum>(config: InheritedColorConfig<Datum>) => config is InheritedColorConfigFromTheme;
export declare const isInheritedColorConfigFromContext: <Datum>(config: InheritedColorConfig<Datum>) => config is InheritedColorConfigFromContext;
/**
