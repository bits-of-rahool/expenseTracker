...
export declare const ArcLabelsLayer: <Datum extends DatumWithArcAndColor>({ center, data, transitionMode, label: labelAccessor, radiusOffset, skipAngle, skipRadius, textColor, component, }: ArcLabelsLayerProps<Datum>) => import("react/jsx-runtime").JSX.Element;
export {};
